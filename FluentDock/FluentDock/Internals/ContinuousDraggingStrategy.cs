...
namespace FluentDock.Internals
{
    internal class ContinuousDraggingStrategy : IDraggingStrategy
    {
        ...
        {
            var itemsControl = grip.ParentOfType<DockGroupControl>();
        ...
        private void MoveGrip(SplitterGrip grip, DockGroupControl itemsControl, double verticalChange, double horizontalChange)
        {
            ...
            var diffUnit = DockGroupControl.GetUnitForSize(itemsControl, Math.Abs(coercedChange));
            try
            {
